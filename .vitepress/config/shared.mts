...
export const shared = defineConfig({
  ...
  head: [
    ...
    ['link', { rel: 'icon', type: 'image/x-icon', href: '/2025-China-Open-Source-Report/image/China-Open-Source-Report.ico' }],
    [
      'script',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/kaiyuanshe/2025-China-Open-Source-Report' },
      {
        icon: {
          svg:
        ...
        }, link: 'https://atomgit.com/kaiyuanshe/2025-China-Open-Source-Report'
      },
      // {
      //   icon: {
      //     svg:
      ...
      //   },
      //   link: 'https://gitee.com/kaiyuanshe/2025-China-Open-Source-Report'
      // }
    ],
